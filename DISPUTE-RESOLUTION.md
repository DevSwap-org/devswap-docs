...
النزاع يتطلّب **حكماً بشرياً على عمل خارج السلسلة** ("هل سلّم المطوّر ما اتُّفق عليه؟") — وهذا ما **لا
يستطيع** عقد ذكي حسمه ذاتياً. لذا وجود **حَكَم بشري (أو أوراكل)** حتمي؛ التصميم الحقيقي هو: *مَن يحكم، كيف
يُختار، كيف يُحفَّز على النزاهة، كيف نمنع الخاسر من التلاعب، وماذا يحدث عند الحوافّ.* اليوم لدينا **طبقة
ثانية محصّنة لكن مركزية** (محكّمون يعيّنهم المالك، حكم ثنائي). أفضل ممارسة لـDevSwap ليست «نموذج واحد» بل
**تدرّج متناسب مع القيمة**: منعُ النزاع أولاً → تسوية ودّية → لوحة محكّمين محايدة (الحالية، مُحسَّنة) → تصعيد
لامركزي للقضايا الكبيرة/المستأنَفة. مع: **كلفة على رفع النزاع** (ضد الابتزاز)، **حكم جزئي** (لا ثنائي فقط)،
**حوافز نزاهة للمحكّم + سجلّ علني**، **استئناف محدود**، و**مخرج آمن** يمنع تجمّد الأموال للأبد. كله محجوب
بالتدقيق وموافقة المالك قبل mainnet.
