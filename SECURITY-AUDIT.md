...
Per Cycle 9 Task 3, the three SWC classes the user flagged as priority on the new V2.3
...
### 8.5 P5 Pre-Mainnet Action (Escrow) — ✅ COMPLETED 2026-05-26 (Cycle 8)
...
## 11. DevSwapEscrowV2_4 — Cycle 10 (2026-05-26)
...
Solc `=0.8.34` · OZ v5.1.0 · **via_ir = true** (Cycle 10 — `_finalize` trips Yul stack-too-deep without IR).
...
### 11.5 V2.2 backward-compatible relaxations (Cycle 10)

| Symbol | Before | After | Rationale |
|--------|--------|-------|-----------|
| `approveJob` | `external` | `public virtual` | Cycle 8 already; required for V2.3 + V2.4 overrides |
...
| `getJob / getMilestone` | `external` | `public` | Cycle 8 already; needed for derived contracts |
...
- Deploy block: 109749817 · Deployer: `0xb60Eef…` (nonce 12→16)
